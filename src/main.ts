...
async function bootstrap() {
  ...
  // forbidNonWhitelisted throws an error and stop the request from ebing processed if there is a property that shouldnt be there - ex: pass isEnable: true to the body of the request
